    ...
    <fieldset>
      ...
      <div class="form-group">
        ...
        <select name="job_type" id="job_type" class="form-control">
          <?php
          $selected = $_POST['job_type'] == AqsController::$viewBag['job_type'] ? "selected" : "";
           ?>
          <option <?php echo $selected; ?> value="Full-time">Full-time</option>
          <option <?php echo $selected; ?> value="Part-time">Part-time</option>
        </select>
      </div>
    <div class="form-group">
